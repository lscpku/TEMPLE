...
version_dirs=( "./exp/qwen25vl7b_temple_sft60k/outputs/qwen25vl7b=lr5e-6_r32_a64_bs16_freeze_r16"/v*-* )
...
DATA_PATH="./swift_data/qwen25vl7b_i0_r8.json"
OUTPUT_DIR="./exp/qwen25vl7b_temple_sft60k/outputs/qwen25vl7b=lr5e-6_r32_a64_bs16_freeze_r16-r8"
