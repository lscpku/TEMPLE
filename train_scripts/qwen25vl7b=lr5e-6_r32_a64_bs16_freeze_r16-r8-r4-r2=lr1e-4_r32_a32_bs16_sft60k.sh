...
version_dirs=( "./exp/qwen25vl7b_temple_sft60k/outputs/qwen25vl7b=lr5e-6_r32_a64_bs16_freeze_r16-r8-r4-r2"/v*-* )
...
DATA_PATH="./swift_data/llava-video-sft-60k.json"
OUTPUT_DIR="./exp/qwen25vl7b_temple_sft60k/outputs/qwen25vl7b=lr5e-6_r32_a64_bs16_freeze_r16-r8-r4-r2=lr1e-4_r32_a32_bs16_sft60k"
...
swift sft \
    ...
    --dataset $DATA_PATH \
    --train_type lora --lora_rank 32 --lora_alpha 32 \
